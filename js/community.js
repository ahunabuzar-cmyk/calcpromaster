...
const CommunityGrowth = (function () {
  ...
  function exportPDF(report) {
    ...
    w.document.write(
      '<!DOCTYPE html><html><head><meta charset="utf-8"><title>CalcProMaster — ' + esc(report.tool) + '</title>' +
      ...
      '.extra{color:#64748b;font-size:14px;margin:8px 0}.meta{color:#94a3b8;font-size:12px}</style></head><body>' +
