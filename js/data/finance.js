...
const FINANCE_TOOLS = [
  ...
  { id: 'savings-goal', name: 'Savings Goal Calculator', desc: 'Savings goal — solve for monthly contribution, target, time, or required rate', kw: 'solve for time, free online Savings Goal Calculator',
    inputs: [
  ...
  { id: 'sales-tax', name: 'Sales Tax Calculator', desc: 'Calculate sales tax on purchases', kw: 'free online Sales Tax Calculator',
  ...
  { id: 'npv', name: 'NPV Calculator', desc: 'Net present value of cash flows', kw: 'net present value, free online NPV Calculator',
  ...
  { id: 'irr', name: 'IRR Calculator', desc: 'Internal rate of return', kw: 'internal rate of return, free online IRR Calculator',
  ...
  { id: 'roi', name: 'ROI Calculator', desc: 'Return on investment', kw: 'return on investment, free online ROI Calculator',
  ...
  { id: 'tip', name: 'Tip Calculator', desc: 'Calculate tip and split bill', kw: 'free online Tip Calculator',
  ...
  { id: 'salary', name: 'Salary Calculator', desc: 'Calculate annual salary breakdown', kw: 'take home pay calculator with deductions, net salary calculator pakistan monthly',
  ...
  { id: 'annuity', name: 'Annuity Calculator', desc: 'Calculate annuity payments', kw: 'future value annuity, free online Annuity Calculator',
  ...
  { id: 'inflation', name: 'Inflation Calculator', desc: 'Calculate inflation impact on purchasing power', kw: 'free inflation calculator, free online Inflation Calculator',
  ...
  { id: 'debt-ratio', name: 'Debt-to-Income Ratio', desc: 'Calculate DTI ratio', kw: 'debt to income, free online Debt-to-Income Ratio calculator',
  ...
  { id: 'net-worth-calculator', name: 'Net Worth Calculator', desc: 'Calculate your net worth', kw: 'net worth calculator, free online Net Worth Calculator',
  ...
  { id: 'rent-vs-buy', name: 'Rent vs Buy Calculator', desc: 'Should you rent or buy a home?', kw: 'rent vs buy, free online Rent vs Buy Calculator',
  ...
  { id: 'refinance', name: 'Refinance Calculator', desc: 'Should you refinance your mortgage?', kw: 'free refinance calculator, free online Refinance Calculator',
  ...
  { id: 'loan-qualify', name: 'Loan Qualification', desc: 'Check loan eligibility', kw: 'free online Loan Qualification calculator',
  ...
  { id: 'paycheck', name: 'Paycheck Calculator', desc: 'Calculate take-home pay', kw: 'free online Paycheck Calculator',
  ...
  { id: 'break-even', name: 'Break-Even Calculator', desc: 'Calculate break-even point', kw: 'break even analysis calculator units, free online Break-Even Calculator',
  ...
  { id: 'cash-flow', name: 'Cash Flow Calculator', desc: 'Project cash flow over time', kw: 'cash flow projection, free online Cash Flow Calculator',
  ...
  { id: 'markup', name: 'Markup Calculator', desc: 'Calculate price markup', kw: 'free markup calculator, free online Markup Calculator',
  ...
  { id: 'discount', name: 'Discount Calculator', desc: 'Calculate sale price after discount', kw: 'free online Discount Calculator',
  ...
  { id: 'present-value', name: 'Present Value Calculator', desc: 'Present value — solve for present value, future value, discount rate, or time', kw: 'time value of money, free online Present Value Calculator',
    inputs: [
  ...
  { id: 'future-value', name: 'Future Value Calculator', desc: 'Future value — solve for future value, present value, rate, or time', kw: 'future value calculator lump sum, free online Future Value Calculator',
    inputs: [
  ...
  { id: 'amortization', name: 'Amortization Schedule', desc: 'Full amortization schedule with breakdown', kw: 'amortization schedule calculator, free online Amortization Schedule calculator',
  ...
  { id: 'loan-to-value', name: 'Loan-to-Value Ratio', desc: 'Calculate LTV ratio', kw: 'free online Loan-to-Value Ratio calculator',
  ...
  { id: 'apr', name: 'APR Calculator', desc: 'Calculate annual percentage rate', kw: 'free online APR Calculator',
  ...
  { id: 'capital-gains', name: 'Capital Gains Tax', desc: 'Calculate capital gains tax', kw: 'free online Capital Gains Tax calculator',
  ...
  { id: 'dividend', name: 'Dividend Calculator', desc: 'Calculate dividend income', kw: 'free dividend calculator, free online Dividend Calculator',
  ...
  { id: 'fire', name: 'FIRE Calculator', desc: 'Financial independence number', kw: 'free fire calculator, free online FIRE Calculator',
  ...
  { id: 'social-security', name: 'Social Security Calculator', desc: 'Estimate social security benefits', kw: 'social security calculator, free online Social Security Calculator',
  ...
  { id: 'rental-yield', name: 'Rental Yield Calculator', desc: 'Calculate rental yield', kw: 'rental yield calculator, free online Rental Yield Calculator',
  ...
  { id: 'loan-comparison', name: 'Loan Comparison', desc: 'Compare multiple loan offers', kw: 'free online Loan Comparison calculator',
  ...
  { id: 'savings-comparison', name: 'Savings Account Comparison', desc: 'Compare savings account rates', kw: 'high yield savings, free online Savings Account Comparison calculator',
  ...
  { id: 'mortgage-payoff', name: 'Mortgage Payoff Calculator', desc: 'Calculate early mortgage payoff savings', kw: 'mortgage payoff calculator extra payments, free online Mortgage Payoff Calculator',
  ...
  { id: 'graduated-payment', name: 'Graduated Payment Mortgage', desc: 'Calculate GPM payments', kw: 'free online Graduated Payment Mortgage calculator',
  ...
  { id: 'balloon-payment', name: 'Balloon Payment Calculator', desc: 'Calculate balloon mortgage payment', kw: 'lump sum payment, free online Balloon Payment Calculator',
  ...
  { id: 'interest-only', name: 'Interest-Only Mortgage', desc: 'Calculate interest-only payments', kw: 'free online Interest-Only Mortgage calculator',
  ...
  { id: 'emergency-fund', name: 'Emergency Fund Calculator', desc: 'Calculate how much you need in your emergency fund', kw: 'rainy day fund, free online Emergency Fund Calculator',
...
{ id: "esop", name: "ESOP Calculator (Employee Stock Ownership)", desc: "Calculate value of employee stock options", kw: "esop calculator, employee stock options, stock options, RSU calculator, free online ESOP Calculator (Employee Stock Ownership)", inputs: [{id:"strikePrice",label:"Strike Price ($)",type:"number",def:10},{id:"currentPrice",label:"Current Stock Price ($)",type:"number",def:25},{id:"options",label:"Number of Options",type:"number",def:1000},{id:"taxRate",label:"Tax Rate (%)",type:"number",def:30}], calc: function(v) { var s=(v.currentPrice-v.strikePrice)*v.options; var p=s*(1-v.taxRate/100); return { result: "Net Profit: $"+p.toFixed(0), chart: Charts.bar([v.strikePrice*v.options,v.currentPrice*v.options,p],["Cost","Value","Profit"]), extra: "Spread: $"+s.toFixed(0)+" | Tax: "+v.taxRate+"%" }; }, steps: function(v) { var s=(v.currentPrice-v.strikePrice)*v.options; var p=s*(1-v.taxRate/100); return ["Step 1: Cost = $"+(v.strikePrice*v.options).toFixed(0),"Step 2: Value = $"+(v.currentPrice*v.options).toFixed(0),"Step 3: Profit = $"+p.toFixed(0)]; } },
  ...
  { id: 'us-income-tax', name: 'US Federal Income Tax Calculator', desc: 'Estimate US federal income tax with marginal brackets (2026)', kw: 'free online US Federal Income Tax Calculator',
  ...
  { id: 'canada-income-tax', name: 'Canada Income Tax Calculator', desc: 'Estimate Canadian federal + provincial income tax (2026)', kw: 'free online Canada Income Tax Calculator',
  ...
  { id: 'australia-income-tax', name: 'Australia Income Tax Calculator', desc: 'Estimate Australian income tax + Medicare levy (2026)', kw: 'free online Australia Income Tax Calculator',
  ...
  { id: 'bond-price', name: 'Bond Price Calculator', desc: 'Calculate present value of a bond', kw: 'bond price calculator present value, free online Bond Price Calculator',
  ...
  { id: 'cd-calculator', name: 'CD Interest Calculator', desc: 'Certificate of Deposit compound interest', kw: 'cd interest calculator certificate of deposit, free online CD Interest Calculator',
  ...
  { id: 'annuity-payout', name: 'Annuity Payout Calculator', desc: 'Sustainable withdrawal from retirement fund', kw: 'annuity payout calculator retirement withdrawal, free online Annuity Payout Calculator',
  ...
  { id: 'dividend-yield', name: 'Dividend Yield Calculator', desc: 'Calculate dividend yield and payout ratio', kw: 'dividend yield calculator, free online Dividend Yield Calculator',
  ...
  { id: 'rule-of-72', name: 'Rule of 72 Calculator', desc: 'Estimate doubling time for investments', kw: 'rule of 72 calculator investment doubling time, free online Rule of 72 Calculator',
  ...
  { id: 'loan-payoff', name: 'Loan Payoff Calculator', desc: 'Calculate months to pay off with extra payments', kw: 'loan payoff calculator extra payments, free online Loan Payoff Calculator',
  ...
  { id: 'retirement-withdrawal', name: 'Retirement Withdrawal Calculator', desc: '4% rule and custom withdrawal rate', kw: 'retirement withdrawal calculator 4 percent rule, free online Retirement Withdrawal Calculator',
  ...
  { id: 'inflation-adjusted', name: 'Inflation Adjusted Return', desc: 'Calculate real return after inflation', kw: 'inflation adjusted return calculator real return, free online Inflation Adjusted Return calculator',
  ...
  { id: 'tax-equivalent-yield', name: 'Tax Equivalent Yield', desc: 'Compare muni bonds to taxable bonds', kw: 'tax equivalent yield calculator municipal bond, free online Tax Equivalent Yield calculator',
  ...
  { id: '529-plan', name: '529 Plan Calculator', desc: 'Education savings growth projections', kw: '529 plan calculator education savings, free online 529 Plan Calculator',
  ...
  { id: 'times-interest-earned', name: 'Times Interest Earned', desc: 'Ability to pay interest expenses', kw: 'times interest earned ratio calculator, free online Times Interest Earned calculator',
  ...
  { id: 'ebitda', name: 'EBITDA Calculator', desc: 'Earnings before interest, taxes, depreciation', kw: 'ebitda calculator, free online EBITDA Calculator',
  ...
  { id: 'enterprise-value', name: 'Enterprise Value Calculator', desc: 'Total value of a company', kw: 'enterprise value calculator ev, free online Enterprise Value Calculator',
  ...
  { id: 'sharpe-ratio', name: 'Sharpe Ratio Calculator', desc: 'Risk-adjusted return metric', kw: 'sharpe ratio calculator risk adjusted return, free online Sharpe Ratio Calculator',
  ...
  { id: 'debt-snowball', name: 'Debt Snowball Calculator', desc: 'Pay off smallest debts first strategy', kw: 'debt snowball calculator debt payoff strategy, free online Debt Snowball Calculator',
  ...
  { id: 'payday-loan-cost', name: 'Payday Loan Cost Calculator', desc: 'True annualized cost of payday loans', kw: 'payday loan cost calculator true cost, free online Payday Loan Cost Calculator',
  ...
  { id: 'emergency-fund-rate', name: 'Emergency Fund Growth', desc: 'How emergency savings grow in HYSA', kw: 'emergency fund growth high yield savings calculator, free online Emergency Fund Growth calculator',
  ...
  { id: 'property-tax', name: 'Property Tax Calculator', desc: 'Annual property tax estimate', kw: 'property tax calculator annual estimate, free online Property Tax Calculator',
  ...
  { id: 'closing-costs', name: 'Closing Costs Calculator', desc: 'Estimate total closing costs for home purchase', kw: 'closing costs calculator home purchase, free online Closing Costs Calculator',
  ...
  { id: 'cap-rate', name: 'Cap Rate Calculator', desc: 'Capitalization rate for real estate', kw: 'cap rate calculator capitalization rate real estate, free online Cap Rate Calculator',
  ...
  { id: 'student-loan-repayment', name: 'Student Loan Repayment', desc: 'Standard repayment plan calculator', kw: 'student loan repayment calculator standard plan, free online Student Loan Repayment calculator',
  ...
  { id: 'cost-of-debt', name: 'Cost of Debt Calculator', desc: 'After-tax cost of borrowing', kw: 'after tax cost of debt calculator, free online Cost of Debt Calculator',
  ...
  { id: 'fha-loan', name: 'FHA Loan Calculator', desc: 'FHA mortgage with MIP insurance', kw: 'fha loan calculator mortgage mip, free online FHA Loan Calculator',
  ...
  { id: 'va-loan', name: 'VA Loan Calculator', desc: 'VA mortgage with no down payment', kw: 'va loan calculator veteran mortgage, free online VA Loan Calculator',
  ...
  { id: 'reverse-mortgage', name: 'Reverse Mortgage Calculator', desc: 'Home equity conversion for retirees', kw: 'reverse mortgage calculator home equity, free online Reverse Mortgage Calculator',
  ...
  { id: 'mortgage-refinance', name: 'Mortgage Refinance Calculator', desc: 'Savings from refinancing your mortgage', kw: 'mortgage refinance calculator should i refinance savings, free online Mortgage Refinance Calculator',
  ...
  { id: 'crypto-gains', name: 'Crypto Gains Calculator', desc: 'Profit/loss on cryptocurrency trades', kw: 'crypto gains calculator cryptocurrency profit loss, free online Crypto Gains Calculator',
  ...
  { id: 'price-to-earnings', name: 'P/E Ratio Calculator', desc: 'Price-to-earnings ratio for stocks', kw: 'pe ratio calculator price to earnings stock, free online P/E Ratio Calculator',
  ...
  { id: 'dividend-discount', name: 'Dividend Discount Model', desc: 'Stock value from future dividends', kw: 'dividend discount model calculator ddm gordon growth, free online Dividend Discount Model calculator',
  ...
  { id: 'margin-call', name: 'Margin Call Price Calculator', desc: 'Price at which margin call triggers', kw: 'margin call calculator stock price threshold, free online Margin Call Price Calculator',
  ...
  { id: 'black-scholes', name: 'Black-Scholes Option Pricing', desc: 'European option price model', kw: 'black scholes option pricing calculator, free online Black-Scholes Option Pricing calculator',
  ...
  { id: 'growing-perpetuity', name: 'Growing Perpetuity Calculator', desc: 'PV of payments growing at constant rate', kw: 'growing perpetuity calculator constant growth, free online Growing Perpetuity Calculator',
  ...
  { id: 'tax-loss-harvest', name: 'Tax Loss Harvesting', desc: 'Offset capital gains with losses', kw: 'tax loss harvesting calculator offset gains losses, free online Tax Loss Harvesting calculator',
  ...
  { id: 'savings-rate', name: 'Savings Rate Calculator', desc: 'What percentage of income you save', kw: 'savings rate calculator personal finance, free online Savings Rate Calculator',
  ...
  { id: 'envelope-budget', name: '50/30/20 Budget Calculator', desc: 'Split income into needs/wants/savings', kw: '50 30 20 budget calculator envelope method, free online 50/30/20 Budget Calculator',
  ...
  { id: 'cost-of-living', name: 'Cost of Living Calculator', desc: 'Compare costs between two cities', kw: 'cost of living calculator compare cities salary adjustment, free online Cost of Living Calculator',
  ...
  { id: 'debt-consolidation', name: 'Debt Consolidation Calculator', desc: 'Compare consolidation loan to multiple debts', kw: 'debt consolidation calculator combine debts, free online Debt Consolidation Calculator',
  ...
  { id: 'yield-to-maturity', name: 'Yield to Maturity Calculator', desc: 'YTM approximation for bonds', kw: 'yield to maturity calculator bond ytm, free online Yield to Maturity Calculator',
  ...
  { id: 'gross-rent-multiplier', name: 'Gross Rent Multiplier', desc: 'Property price divided by gross annual rent', kw: 'gross rent multiplier calculator grm real estate, free online Gross Rent Multiplier calculator',
  ...
  { id: 'current-ratio-finance', name: 'Current Ratio Calculator', desc: 'Current assets divided by current liabilities', kw: 'current ratio calculator liquidity, free online Current Ratio Calculator',
  ...
  { id: 'accounts-receivable-turnover', name: 'AR Turnover Ratio', desc: 'How quickly receivables are collected', kw: 'accounts receivable turnover ratio calculator, free online AR Turnover Ratio calculator',
  ...
  { id: 'operating-margin', name: 'Operating Margin Calculator', desc: 'Operating income as percentage of revenue', kw: 'operating margin calculator, free online Operating Margin Calculator',
  ...
  { id: 'net-profit-margin', name: 'Net Profit Margin', desc: 'Net income as percentage of revenue', kw: 'net profit margin calculator, free online Net Profit Margin calculator',
  ...
  { id: 'coverage-ratio', name: 'Debt Coverage Ratio', desc: 'NOI divided by debt service', kw: 'debt coverage ratio calculator dscr, free online Debt Coverage Ratio calculator',
  ...
  { id: 'cash-on-cash', name: 'Cash-on-Cash Return', desc: 'Annual pre-tax cash flow / total cash invested', kw: 'cash on cash return calculator real estate investment, free online Cash-on-Cash Return calculator',
  ...
  { id: 'loan-balance', name: 'Loan Balance Calculator', desc: 'Remaining balance after payments', kw: 'loan balance calculator remaining balance, free online Loan Balance Calculator',
  ...
  { id: 'discounted-payback', name: 'Discounted Payback Period', desc: 'Time to recover investment at discount rate', kw: 'discounted payback period calculator, free online Discounted Payback Period calculator',
  ...
  { id: 'payroll-tax', name: 'Payroll Tax Calculator', desc: 'FICA + Medicare tax on wages', kw: 'payroll tax calculator fica medicare social security, free online Payroll Tax Calculator',
  ...
  { id: 'standard-deduction', name: 'Standard vs Itemized Deduction', desc: 'Which deduction method saves more tax', kw: 'standard deduction vs itemized deduction calculator',
  ...
  { id: 'estimated-tax', name: 'Estimated Tax Calculator', desc: 'Quarterly estimated tax payments', kw: 'estimated tax calculator quarterly self employed, free online Estimated Tax Calculator',
  ...
  { id: 'diversification', name: 'Portfolio Diversification', desc: 'How diversified is your investment mix', kw: 'portfolio diversification calculator asset allocation, free online Portfolio Diversification calculator',
  ...
  { id: 'forex-pip', name: 'Forex Pip Calculator', desc: 'Value of a pip in forex trading', kw: 'forex pip calculator value lot size, free online Forex Pip Calculator',
  ...
  { id: 'currency-arbitrage', name: 'Currency Arbitrage Detector', desc: 'Check for triangular arbitrage opportunities', kw: 'triangular arbitrage calculator currency exchange profit, free online Currency Arbitrage Detector calculator',
  ...
  { id: 'payback-period', name: 'Simple Payback Period', desc: 'Years to recover initial investment', kw: 'payback period calculator investment recovery, free online Simple Payback Period calculator',
  ...
  { id: 't-bill', name: 'T-Bill Calculator (Price & Yield)', desc: 'Treasury bill discount yield and price (US 360-day convention)', kw: 't bill calculator treasury bill price yield discount, free online T-Bill Calculator (Price & Yield)',
  ...
  { id: 'cagr', name: 'CAGR Calculator', desc: 'Compound annual growth rate of an investment', kw: 'cagr calculator compound annual growth rate investment return',
  ...
  { id: 'capm', name: 'CAPM Calculator', desc: 'Expected return via the capital asset pricing model', kw: 'capm calculator capital asset pricing model expected return beta, free online CAPM Calculator',
  ...
  { id: 'dcf', name: 'DCF Valuation Calculator', desc: 'Discounted cash flow with terminal value', kw: 'dcf calculator discounted cash flow valuation terminal value, free online DCF Valuation Calculator',
  ...
  { id: 'debt-to-equity', name: 'Debt-to-Equity Ratio', desc: 'Leverage ratio: liabilities divided by shareholders equity', kw: 'debt to equity ratio calculator leverage, free online Debt-to-Equity Ratio calculator',
  ...
  { id: 'insurance-surrender-value', name: 'Insurance Surrender Value', desc: 'Guaranteed surrender value of a life policy', kw: 'insurance surrender value calculator life policy lapsed, free online Insurance Surrender Value calculator',
  ...
  { id: 'espp', name: 'ESPP Calculator (Stock Purchase Plan)', desc: 'Employee stock purchase plan discount and gain', kw: 'espp calculator employee stock purchase plan discount lookback, free online ESPP Calculator (Stock Purchase Plan)',
...
,
  ...
  { id: 'recast-mortgage', name: 'Mortgage Recast Calculator', desc: 'New payment after a lump-sum principal payment', kw: 'mortgage recast calculator recasting loan payment, free online Mortgage Recast Calculator',
  ...
  { id: 'biweekly-mortgage', name: 'Biweekly Mortgage Calculator', desc: 'Save by paying half your mortgage every two weeks', kw: 'biweekly mortgage calculator accelerated payments savings, free online Biweekly Mortgage Calculator',
  ...
  { id: 'mortgage-points', name: 'Mortgage Points Calculator', desc: 'Do discount points pay off? Break-even analysis', kw: 'mortgage points calculator break even discount points, free online Mortgage Points Calculator',
  ...
  { id: 'rent-affordability', name: 'Rent Affordability Calculator', desc: 'How much rent can you afford?', kw: 'rent affordability calculator how much rent can i afford',
  ...
  { id: 'dividend-reinvestment', name: 'Dividend Reinvestment Calculator', desc: 'DRIP growth with reinvested dividends', kw: 'dividend reinvestment calculator drip compounding, free online Dividend Reinvestment Calculator',
  ...
  { id: 'stock-split', name: 'Stock Split Calculator', desc: 'New share count and price after a split', kw: 'stock split calculator forward reverse ratio, free online Stock Split Calculator',
  ...
  { id: 'net-operating-income', name: 'NOI Calculator', desc: 'Net operating income for income properties', kw: 'net operating income calculator noi real estate, free online NOI Calculator',
  ...
  { id: 'dso', name: 'Days Sales Outstanding (DSO)', desc: 'Average days to collect payment after a credit sale', kw: 'dso calculator days sales outstanding receivables collection period, free online Days Sales Outstanding (DSO) calculator',
  ...
  { id: 'rule-of-40', name: 'Rule of 40 Calculator', desc: 'SaaS growth plus profit margin health check', kw: 'rule of 40 calculator saas growth margin software company, free online Rule of 40 Calculator',
  ...
  { id: 'cost-of-delay', name: 'Cost of Delay Calculator', desc: 'Revenue lost per month a launch or decision slips', kw: 'cost of delay calculator product launch revenue lost month, free online Cost of Delay Calculator',
