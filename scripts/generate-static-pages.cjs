...
const PAGES = {
  'about': { title: 'About CalcProMaster', desc: 'About CalcProMaster — a free collection of 1206+ online calculators for finance, health, math, science and everyday life, all running in your browser.', content: LegalPages.ABOUT_PAGE },
...
<body>
  ...
  <main>${body}</main>
  <footer>
    <a href="/">CalcProMaster</a> · 1206+ free online calculators · All calculations run in your browser
